...
public:
	...
	Matrix(const vedo::vedo_uint_t& rows, const vedo::vedo_uint_t& columns);
	...
	void Resize(const vedo::vedo_uint_t& rows, const vedo::vedo_uint_t& columns);

	// Retrieves the number of rows  of this matrix
	inline vedo::vedo_uint_t rows() const
	{
		return _rows;
	}

	// Retrieves the number of columns of this matrix
	inline vedo::vedo_uint_t columns() const
	{
		return _cols;
	}
	 ...
	 ******************************************************************************************/
	const Matrix& operator = (const vedo::vedo_float_t& v);
	 ...
	 ********************************************************************************************************************/
	Matrix Select(vedo::vedo_uint_t* selected, vedo::vedo_uint_t len) const;
	...
	vedo::vedo_float_t Get(const vedo::vedo_uint_t& r, const vedo::vedo_uint_t& c) const;

	// Retrieves references of element (r,c)
	vedo::vedo_float_t & operator() (const vedo::vedo_uint_t& r, const vedo::vedo_uint_t& c);

private:

	// _rows : the number of rows  of this matrix
	vedo::vedo_uint_t _rows;

	// _cols: the number of columns of this matrix
	vedo::vedo_uint_t _cols;

	// Matrix and matval : these two pointers are used to indicate all the elements of the matrix

	vedo::vedo_float_t** matrix;

	vedo::vedo_float_t*  matval;
