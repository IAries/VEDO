...
public:
	...
	inline const bool& GetSwitch(vedo_uint_t i) const
	{
		return bSwitch[i];
	}
	...
	inline const vedo_float_t GetVolume() const
	{
		return dVolume;
	};
	...
	bool InBoundary(const njr::Vector3d, const vedo_float_t) const;
...
private:
	...
	vedo_float_t  dVolume;       // Volume (space inside the boundary)
