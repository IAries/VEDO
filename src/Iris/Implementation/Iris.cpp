...
void usage (int g)
{
    cout
		...
		<< "Mode  : geometric/graph/show/redistribute\n"
		<< "Record: integer\n"
		<< "UpIact: integer\n\n"
		<< "Error Condition: "
		<< g
...
//	  		pConsultant = new DConsultant(pDOWorld , argv[2], RecordStep, UpIact);
	}
	else
    {
		usage();
...
*/
	...
	else if (!strcmp(mode, "redistribute"))   // Use default value: Geometric partitioning
	{
		pConsultant = new NBSParallelConsultant(pDOWorld, pIactRecordTab, idofilename, RecordStep, UpIact);
	}
	else
